...
(function (window, document, undefined) {
        ...
        if (b)
            for (var d in b)
                if (b.hasOwnProperty(d))
                    d == "style" ? q(this, a, b[d]) : a.setAttribute(d, b[d]);
    ...
    z.prototype.parse = function () {
        return this.c.indexOf("MSIE") != -1
            ? ca(this)
            : this.c.indexOf("Opera") != -1
            ? da(this)
            : this.c.indexOf("AppleWebKit") != -1
            ? ea(this)
            : this.c.indexOf("Gecko") != -1
            ? fa(this)
            : ba;
    };
    function A(a) {
    ...
    function ea(a) {
        ...
        var f = "Unknown";
        if (a.c.indexOf("Version/") != -1)
            f = C(a, a.c, /Version\/([\d\.\w]+)/, 1);
        else if (e == "Chrome") f = C(a, a.c, /Chrome\/([\d\.]+)/, 1);
    ...
    function fa(a) {
        ...
        if (e == "") e = "Unknown";
            ...
            d =
                ...
                (d == 1 && f > 9) ||
                (d == 1 && f == 9 && g >= 2) ||
                e.match(/1\.9\.1b[123]/) != null ||
                e.match(/1\.9\.1\.[\d\.]+/) != null;
        }
    ...
    function J(a) {
        ...
        x(a.a, a.g, a.h.e(a.j, "active")) ||
            v(a.a, a.g, a.h.e(a.j, "inactive"));
        I(a, "inactive");
    }
    function ia(a) {
        w(a.a, a.g, a.h.e(a.j, "loading"));
    ...
    L.prototype.ra = function (a, b) {
        var c = this.A;
        w(c.a, c.g, c.h.e(c.j, a, b, "loading"));
        x(c.a, c.g, c.h.e(c.j, a, b, "active")) ||
            v(c.a, c.g, c.h.e(c.j, a, b, "inactive"));
    ...
    N.prototype.J = function () {
        var a = this.n.p(this.Q),
            b = this.n.p(this.R);
        if ((this.O != a || this.P != b) && this.ca == a && this.da == b)
            Q(this, this.H);
    ...
    function R(a, b, c, d) {
        c = a.v.expand(c);
        return (
            "position:absolute;top:-999px;left:-999px;font-size:300px;width:auto;height:auto;line-height:normal;margin:0;padding:0;font-variant:normal;font-family:" +
            (d ? "" : a.Aa.quote(a.L) + ",") +
            b +
            ";" +
            c
    ...
    V.prototype.J = function () {
        ...
        if ((this.O != a || this.P != b) && !this.t[a] && !this.t[b])
            Q(this, this.H);
        else if (this.D() - this.ia >= 5e3)
            this.t[a] && this.t[b] && xa[this.L]
                ? Q(this, this.H)
                : Q(this, this.$);
        else qa(this);
    };
    function ya(a) {
        this.I = a
            ? a
            : ("https:" == window.location.protocol ? "https:" : "http:") + za;
        this.f = [];
        this.S = [];
    }
    ...
    W.prototype.load = function (a) {
        var b = this.a;
        this.c.getName() == "MSIE" && this.d.blocking != true
            ? aa(b, n(this, this.ba, a))
            : this.ba(a);
    };
    ...
    Y.prototype.C = function (a) {
        return (
            ("https:" == this.m.location.protocol ? "https:" : "http:") +
            (this.d.api || "//f.fontdeck.com/s/css/js/") +
            this.m.document.location.hostname +
            "/" +
            a +
            ".js"
        );
    ...
    Y.prototype.z = function (a, b) {
        ...
        var c = this;
        if (a) {
            this.m.__webfontfontdeckmodule__ ||
                (this.m.__webfontfontdeckmodule__ = {});
            this.m.__webfontfontdeckmodule__[a] = function (d, e) {
                for (var f = 0, g = e.fonts.length; f < g; ++f) {
                    ...
                    c.s[h.name] = [
                        c.v.compact(
                            "font-weight:" + h.weight + ";font-style:" + h.style
                        ),
                    ];
                }
                b(d);
    ...
    Z.prototype.C = function (a) {
        var b = this.protocol(),
            c = (this.d.api || "fast.fonts.com/jsapi").replace(
                /^.*http(s?):(\/\/)?/,
                ""
            );
        return b + "//" + c + "/" + a + ".js";
    ...
    Z.prototype.protocol = function () {
        ...
        if (this.k && this.k.location && this.k.location.protocol) {
            ...
            for (c = 0; c < a.length; c++)
                if (this.k.location.protocol === a[c])
    ...
    $.prototype.z = function (a, b) {
        var c = this.d.id,
            ...
            e = this;
        if (c) {
            this.m.__webfonttypekitmodule__ ||
                (this.m.__webfonttypekitmodule__ = {});
