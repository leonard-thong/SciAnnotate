...
*/ (function (
    ...
    var b = a.documentElement,
        ...
        h = {},
        i =
            a.createElement("script").async === true ||
            "MozAppearance" in a.documentElement.style ||
            window.opera;
    var j = (window.head_conf && head_conf.head) || "head",
        k = (window[j] =
            window[j] ||
            function () {
    ...
    function w(a, b) {
        a.state ||
            ((a.state = m),
            (a.onpreload = []),
            y({ src: a.url, type: "cache" }, function () {
                v(a);
            }));
    }
    function x(a, b) {
    ...
    window.addEventListener
        ? (a.addEventListener("DOMContentLoaded", z, false),
          window.addEventListener("onload", z, false))
        : window.attachEvent &&
        ...
        !a.readyState &&
            ...
            a.addEventListener(
                "DOMContentLoaded",
                (handler = function () {
                    a.removeEventListener("DOMContentLoaded", handler, false),
