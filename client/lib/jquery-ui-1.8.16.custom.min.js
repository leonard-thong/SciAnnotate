    ...
    b.widget("ui.mouse", {
        ...
        _mouseInit: function () {
            ...
            this.element
                ...
                .bind("click." + this.widgetName, function (c) {
                    if (
                        true ===
                        b.data(c.target, a.widgetName + ".preventClickEvent")
                    ) {
                        b.removeData(
                            c.target,
        ...
        _mouseDown: function (a) {
            if (!d) {
                ...
                true ===
                    b.data(a.target, this.widgetName + ".preventClickEvent") &&
                    b.removeData(
                        a.target,
        ...
        return this.each(function () {
            var f = c(this),
                ...
                v =
                    l +
                    p +
                    (parseInt(c.curCSS(this, "marginRight", true)) || 0),
                w =
                    m +
                    q +
                    (parseInt(c.curCSS(this, "marginBottom", true)) || 0),
                i = c.extend({}, j),
                r;
        ...
        _generatePosition: function (a) {
            ...
            if (this.originalPosition) {
                ...
                if (b.grid) {
                    ...
                    h = g
                        ? !(
                              h - this.offset.click.top < g[1] ||
                              h - this.offset.click.top > g[3]
                          )
                            ? h
                            : !(h - this.offset.click.top < g[1])
                            ? h - b.grid[1]
                    ...
                    e = g
                        ? !(
                              e - this.offset.click.left < g[0] ||
                              e - this.offset.click.left > g[2]
                          )
                            ? e
                            : !(e - this.offset.click.left < g[0])
                            ? e - b.grid[0]
        ...
        drag: function (a, b) {
            for (
                var c = d(this).data("draggable"),
                    ...
                    n = b.offset.top,
                    o = n + c.helperProportions.height,
                    i = c.snapElements.length - 1;
                i >= 0;
                i--
            ) {
...
(function (c) {
    c.widget("ui.accordion", {
        ...
        _create: function () {
            ...
            a.headers
                .attr("role", "tab")
                .bind("keydown.accordion", function (f) {
                    return a._keydown(f);
                })
                .next()
                .attr("role", "tabpanel");
                            ...
                            .animate(g, {
                                step: function (j, i) {
                                    ...
                                    a.toShow[0].style[i.prop] =
                                        h * f[i.prop].value + f[i.prop].unit;
                                },
                                duration: a.duration,
                                easing: a.easing,
                                complete: function () {
        ...
        _create: function () {
            ...
            this.element
                ...
                .bind("keydown.autocomplete", function (c) {
                    if (
                        !(a.options.disabled || a.element.propAttr("readOnly"))
                    ) {
                        g = false;
                        var f = d.ui.keyCode;
                        switch (c.keyCode) {
            ...
            this.menu = d("<ul></ul>")
                ...
                .menu({
                    focus: function (c, f) {
                        ...
                        false !== a._trigger("focus", c, { item: f }) &&
                    ...
                    selected: function (c, f) {
                        ...
                        false !== a._trigger("select", c, { item: h }) &&
...
(function (d) {
    d.widget("ui.menu", {
            ...
            if (this.hasScroll())
                if (!this.active || this.first())
                    ...
                    result = this.element
                        ...
                        .filter(function () {
                            var g =
                                d(this).offset().top - a + b - d(this).height();
                            return g < 10 && g > -10;
                        });
                    result.length ||
        ...
        hasScroll: function () {
            return (
                this.element.height() <
                this.element[d.fn.prop ? "prop" : "attr"]("scrollHeight")
            );
        },
        select: function (e) {
    ...
    var h,
        ...
        k = function (a) {
            ...
            if (c)
                f = e
                    ? b(e).find("[name='" + c + "']")
                    : b("[name='" + c + "']", a.ownerDocument).filter(
                          function () {
                              return !this.form;
                          }
                      );
        ...
        _resetButton: function () {
            if (this.type === "input")
                ...
                if (e.primary || e.secondary) {
                    ...
                    if (!this.options.text) {
                        d.push(
                            f ? "ui-button-icons-only" : "ui-button-icon-only"
                        );
        ...
        _refreshValue: function () {
            ...
            if (this.options.values && this.options.values.length)
                this.handles.each(function (h) {
                    e =
                        ((c.values(h) - c._valueMin()) /
                            (c._valueMax() - c._valueMin())) *
                        100;
                    j[c.orientation === "horizontal" ? "left" : "bottom"] =
                        e + "%";
                ...
                if (a === "min" && this.orientation === "horizontal")
                    this.range
                        .stop(1, 1)
                        [f ? "animate" : "css"]({ width: e + "%" }, b.animate);
                ...
                if (a === "min" && this.orientation === "vertical")
                    this.range
                        .stop(1, 1)
                        [f ? "animate" : "css"]({ height: e + "%" }, b.animate);
    ...
    d.widget("ui.tabs", {
        ...
        _tabify: function (b) {
            ...
            this.anchors.each(function (g, f) {
                ...
                if (h.test(i))
                    a.panels = a.panels.add(
                        a.element.find(a._sanitizeSelector(i))
                    );
                else if (i && i !== "#") {
            ...
            if (b) {
                ...
                if (c.selected >= 0 && this.anchors.length) {
                    a.element
                        .find(a._sanitizeSelector(a.anchors[c.selected].hash))
        ...
        add: function (b, e, a) {
            ...
            var c = this,
                h = this.options;
            e = d(
                h.tabTemplate.replace(/#\{href\}/g, b).replace(/#\{label\}/g, e)
            );
            b = !b.indexOf("#")
                ? b.replace("#", "")
                : this._tabId(d("a", e)[0]);
...
(function (d, C) {
                ...
                if (
                    !(
                        d.datepicker._isDisabledDatepicker(
                            J.inline ? a.parent()[0] : J.input[0]
                        ) || !b.length
                    )
                ) {
                    b.parents(".ui-datepicker-calendar")
                        .find("a")
                        .removeClass("ui-state-hover");
    ...
    d.extend(M.prototype, {
        ...
        _doKeyPress: function (a) {
            ...
            if (d.datepicker._get(b, "constrainInput")) {
                ...
                var c = String.fromCharCode(
                    a.charCode == C ? a.keyCode : a.charCode
                );
                return (
                    a.ctrlKey || a.metaKey || c < " " || !b || b.indexOf(c) > -1
                );
            }
        },
        _doKeyUp: function (a) {
        ...
        _showDatepicker: function (a) {
            ...
            if (
                ...
                if (d.datepicker._curInst && d.datepicker._curInst != b) {
                    d.datepicker._datepickerShowing &&
                        d.datepicker._triggerOnClose(d.datepicker._curInst);
        ...
        _updateDatepicker: function (a) {
            ...
            c > 1 &&
                a.dpDiv
                    .addClass("ui-datepicker-multi-" + c)
                    .css("width", 17 * c + "em");
            a.dpDiv[(b[0] != 1 || b[1] != 1 ? "add" : "remove") + "Class"](
                "ui-datepicker-multi"
            );
        ...
        parseDate: function (a, b, c) {
                ...
                var f =
                    ...
                    n = function (p, D, K) {
                        ...
                        d.each(p, function (w, x) {
                            w = x[1];
                            if (
                                b.substr(q, w.length).toLowerCase() ==
                                w.toLowerCase()
                            ) {
                                E = x[0];
                                q += w.length;
            ...
            if (q < b.length)
                throw (
                    "Extra/unparsed characters found in date: " + b.substring(q)
                );
        ...
        _generateHTML: function (a) {
            ...
            n = !h
                ...
                : this.formatDate(
                      n,
                      this._daylightSavingAdjust(new Date(m, g - j, 1)),
            ...
            for (
                var E = this._getDefaultDate(a), w = "", x = 0;
                x < i[0];
                x++
            ) {
                var O = "";
                ...
                for (var G = 0; G < i[1]; G++) {
                    ...
                    for (var Q = 0; Q < z; Q++) {
                        ...
                        for (t = 0; t < 7; t++) {
                            var I = p
                                    ? p.apply(a.input ? a.input[0] : null, [r])
                                    : [true, ""],
                                F = r.getMonth() != g,
                                L =
                                    (F && !K) ||
        ...
        _getDaysInMonth: function (a, b) {
            return (
                32 - this._daylightSavingAdjust(new Date(a, b, 32)).getDate()
            );
        },
