    ...
    var URLMonitor = function (dispatcher) {
        ...
        var setArguments = function (args, force) {
            ...
            if (changed) {
                ...
                force ||
                !Util.isEqual(that.url_hash.intArguments, argSplit[0])
            ) {
                ...
                dispatcher.post("current", [
                    that.url_hash.collection,
                    that.url_hash.document,
                    that.url_hash.arguments,
                    reloadData,
                ]);
                reloadData = true;
            }
        ...
        var updateState = function () {
            ...
            if (!changed) {
                ...
                setCollection(
                    new_url_hash.collection,
                    new_url_hash.document,
