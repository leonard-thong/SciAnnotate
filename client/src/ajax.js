                ...
                success: function (response) {
                    ...
                    if (
                        ...
                        console.error(
                            "Action " +
                                data.action +
                                " returned the results of action " +
                                response.action
                        );
                            ...
                            [
                                [
                                    "Protocol error: Action" +
                                        ...
                                        " returned the results of action " +
                                        response.action +
                                        " maybe the server is unable to run, please run tools/troubleshooting.sh from your installation to diagnose it",
                                    "error",
                                    -1,
                                ],
                            ],
                    ...
                    if (pendingList.hasOwnProperty(id)) {
                        ...
                        if (
                            response.exception == "configurationError" ||
                                ...
                                if (
                                    confirm(
                                        "The server is running a different version " +
                                            "from dlmat than your client, possibly due to a " +
