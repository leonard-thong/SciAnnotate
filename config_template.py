...
# This configuration file specifies the global setup of the dlmat
...
# command in the dlmat directory:
#
#     ./install.sh
#
# if you wish to configure the server manually, you will first need to
# make sure that this file appears as config.py in the dlmat server
...
# Directories required by the dlmat server:
#
...
# If you have installed dlmat as suggested in the installation
...
# The following options control advanced aspects of the dlmat server
# setup.  It is not necessary to edit these in a basic dlmat server
# installation.
