...
# Creates SQL and simstring DBs for dlmat normalization support.
...
# Guessing that we might be in the dlmat tools/ directory ...
...
def argparser():
    ...
    ap.add_argument(
        ...
        "--database",
        default=None,
        help="Base name of databases to create (default by input file name in dlmat work directory)")
    ap.add_argument(
        "-e",
        "--encoding",
