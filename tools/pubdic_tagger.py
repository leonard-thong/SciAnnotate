...
try:
    ...
    # likely old Python; try to fall back on ujson in dlmat distrib
...
def convert_for_dlmat(pubdic_result, text):
    anns = {}
...
class RandomTaggerHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        try:
            ...
            # Format the result for dlmat
            json_dic = convert_for_dlmat(json.loads(res), text)
